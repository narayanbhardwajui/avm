  ...
  <div class="text-center shdw-bg"
   ...
   <section>
      ...
      <div class="entry-content">
          ...
          <h3 class="fw-bold">At AVM, Our Appraisers Are Our Number One Asset and Our Top Priority.</h3>
          <a class="btn btn-danger" href="https://acevaluemanagement.spurams.com/AppraiserSelfRegistration.aspx" target="_blank"  style="
    align-self: center;"><span>Join Us Today!</span></a></div>
          ...
          <ul>
          <li>Complete a background check for staff appraiser eligibility.</li>
          <li>State licensed and/or certified.</li>
          <li>Work qualified orders efficiently and quickly.</li>
          <li>Review your reports for quality control issues prior to report submission to AVM.</li>
          <li>Exclusively work for Ace Value Management - provide regular status updates on open orders.</l>
          </ul>
      </div>
      </section>
  <!-- End #main section -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            <h3>Become Part of Our Dream Team of Licensed Professional Appraisers.</h3>
            <p>We’re growing fast. Our application takes only a few minutes to complete.</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="https://acevaluemanagement.spurams.com/AppraiserSelfRegistration.aspx">Sign Up</a>
          </div>
        </div>

...
<body>
  ...
  <div class="text-center shdw-bg"
      style="background: url(assets/img/privacypolicyHerobanner.jpg) no-repeat center / cover;height: 75vh;display:flex;align-items:center;justify-content:center">
    ...
    <section id="about-us" class="about-us">
      <div class="container">
            ...
            <h2 class="fw-bold text-primary">Ace Value Management (AVM) - Privacy Policy</h2>
